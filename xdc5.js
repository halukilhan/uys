...
var GM_config = {
    ...
    open: function() {
        ...
        GM_config.frame.addEventListener('load', function(){
            ...
            frameBody.appendChild(obj.create('div', {id:'buttons_holder', kids:new Array(
                ...
                obj.create('div', {className:'reset_holder block2', kids:new Array(
                    obj.create('a',{id:'resetLink2',target:'_blank',href:'https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=YTHAGS7DE48H4&lc=US&item_name=unique%20youtube%20skin&item_number=halukilhan&currency_code=USD&bn=PP%2dDonationsBF%3aWlO7h9R%3aNonHosted',title:'Restore settings to default configuration',className:'reset2', kids:new Array(
                        obj.create('img',{id:'resetLink2',src:'http://imgur.com/l9XuCK3.png',className:'reset2'})
                    )})
                )})
            )}));
    ...
    css: {
        ...
        '.reset2, .reset2 a, reset_holder block2 {float:left; color:#000000;}\n' +
